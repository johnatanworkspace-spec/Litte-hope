...
![Little Hope — Main Street](./green-hope-main-street.png)
...
```text
little-hope/
├── green-hope.html              # Estrutura e conteúdo da página
├── green-hope.css               # Estilos, responsividade e mapa
├── green-hope.js                # Interações e dados da experiência
├── green-hope-main-street.png   # Fotografia principal da cidade
...
3. Abra `green-hope.html` em um navegador moderno.
...
```text
http://localhost:8000/green-hope.html
```
